...
- Code in [note](./note) are standalone scripts.
...
Every time you change something in your codebase, the installed package in your python environment will also change. Typically, this is what you want: to see your changes reflected immediately.
